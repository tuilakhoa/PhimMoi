...
const firebaseConfig = {
  ...
  firestoreDatabaseId: import.meta.env.VITE_FIREBASE_FIRESTORE_DATABASE_ID || localFirebaseConfig.firestoreDatabaseId || "(default)",
};
...
export const signInWithGoogle = async () => {
  try {
    ...
    if (error.code === 'auth/unauthorized-domain') {
      alert("Lỗi: Tên miền này chưa được cấp phép trong Firebase Console.\n\nHãy thêm domain này vào 'Authentication > Settings > Authorized domains' trong Firebase.");
    }
